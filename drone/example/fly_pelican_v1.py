...
while get_distance_metres(vehicle.location.global_relative_frame, a_location1) >= 0.5 and abs(vehicle.location.global_relative_frame.alt - a_location1.alt) >= 0.4:
